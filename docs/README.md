...
| [2026-09-08_AI체험페이지.md](2026-09-08_AI%EC%B2%B4%ED%97%98%ED%8E%98%EC%9D%B4%EC%A7%80.md) | **9/8 작업** — `/ai` 기사 판독 체험 + 개발 기록 페이지. 링크 크롤링·SSRF 방어·라벨별 성적표. **배포 시 백엔드도 함께 올려야 함** | 2026-09-08 |
